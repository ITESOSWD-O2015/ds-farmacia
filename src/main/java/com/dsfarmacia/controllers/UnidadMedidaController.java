...
public class UnidadMedidaController {
	...
	public static BeanUnidadMedida save(BeanUnidadMedida bean){ // El metodo recibe el bean del metodo POST
	...
	public BeanUnidadMedida update(BeanUnidadMedida bean){ // El metodo recibe el bean del metodo PUT
	...
	public static UnidadMedidaController getController(){ //Metodo que envia el controlador al servicio REST
