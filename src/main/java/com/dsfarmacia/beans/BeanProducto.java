...
public class BeanProducto {
  ...
  public String toString() {
    return "BeanProducto [productId=" + productId + ", productoNombre=" + productonombre + ", "
       + "precioUnitario=" + preciounitario + ", precioVenta=" + precioventa + ", "
       + "cantidad=" + cantidad + ", iva=" + iva + ", fechaCaducicad=" + fechacaducidad + ","
